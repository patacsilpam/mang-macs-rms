...
function mailOrderProcessing($email,$orderNumber,$logo,$customerName,$orderDate,$orderType) {
    ...
    $mail->Body = "<div class='container' style='padding: 1rem;'>
        <div style='display: flex; flex-direction: column; align-items: center;'>
            ...
            <div style='text-align: center;'>
                ...
                <p style='text-align:justify;''>Thank you for purchasing at <b>Mang Mac's Food Shop.</b> Your order <span>".$orderNumber."</span> has been confirmed.</p>
            </div>
        </div>

...
function mailOrderCanceled($email,$orderNumber,$logo,$customerName,$orderDate,$orderType) {
    ...
    $mail->isHTML(true);   
    $mail->Subject = "Your Order #".$orderNumber." is canceled.";
    $mail->Body = "<div class='container' style='padding: 1rem;'>
        <div style='display: flex; flex-direction: column; align-items: center;'>
            ...
            <div style='text-align: center;'>
                ...
                <p style='text-align:justify;''>Your Order #".$orderNumber." has been canceled due to your illicit payment.</p>
            </div>
        </div>

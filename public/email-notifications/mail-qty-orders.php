...
function mailQtyOrder($email,$orderNumber,$logo,$customerName,$orderDate,$orderType) {
    ...
    $mail->Body = "<div class='container' style='padding: 1rem;'>
        <div style='display: flex; flex-direction: column; align-items: center;'>
            ...
            <div style='text-align: center;'>
                ...
                <p style='text-align:justify;'>Due to the quantity of your orders, we have decided to adjust your set order time. Thank you for your patience.</p>
            </div>
        </div>

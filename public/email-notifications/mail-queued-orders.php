...
function mailQueuedOrder($email,$orderNumber,$logo,$customerName,$orderDate,$orderType) {
    ...
    $mail->isHTML(true);   
    $mail->Subject = "Your Order #".$orderNumber." set order time  is adjusted.";
    $mail->Body = "<div class='container' style='padding: 1rem;'>
        <div style='display: flex; flex-direction: column; align-items: center;'>
            ...
            <div style='text-align: center;'>
                <h3>Your set order time is adjusted!</h3>
                <!---Display customer name here using php-->
                <p>Hello ".$customerName."</p>
                <p style='text-align:justify;''>Due to the multiple queued orders, we have decided to adjust your set order time. Thank you for your patience.</p>
            </div>
        </div>

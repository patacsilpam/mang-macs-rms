...
function mailOutOfStock($email,$orderNumber,$logo,$customerName,$orderDate,$orderType) {
    ...
    $mail->Body = "<div class='container' style='padding: 1rem;'>
        <div style='display: flex; flex-direction: column; align-items: center;'>
            ...
            <div style='text-align: center;'>
                <h3>Your order is out of stock!</h3>
                <!---Display customer name here using php-->
                <p>Hello ".$customerName."</p>
                <p style='text-align:justify;''>Your order #".$orderNumber." is out of stock.</p>
            </div>
        </div>

if($orderType == "Deliver"){
                if($orderStatus == "Pending"){
                    ...
                    $OrderStatuss = $connect->prepare("UPDATE tblorderdetails SET order_status=?,completed_time=?,notif_date=? WHERE order_number=?");
                    $OrderStatus->bind_param('ssss',$orderStatuss,$completedTime,$notifDate,$orderNumber);
                    $OrderStatus->execute();
